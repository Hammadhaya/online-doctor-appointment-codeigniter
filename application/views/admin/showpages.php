                                ...
                                <table class="table mb-0 table-center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-bottom p-2" style="min-width: 100px;">Slug</th>
                                    ...
                                    <tbody>
                                        <?php if (@$pages) {
                                            foreach ($pages as $item) { ?>
                                                <tr>
                                                    <th class="p-3"><?= $item['pg_id'] ?></th>
                                                    <td class="p-3"> <?= $item['pg_name'] ?></td>
                                                    <td class="p-3"><?= $item['slug'] ?></td>
                                                    <!-- <td class="p-3"><?= $item['status'] ?></td> -->
                                                    <td> <a href="<?= base_url('pgdelete/' . $item['pg_id']) ?>"><i style="font-size:20px;color:red;" class="fa fa-trash" aria-hidden="true"></i></a>
