                                ...
                                <table class="table mb-0 table-center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-bottom p-2">Phone</th>
                                            ...
                                            <th class="border-bottom p-2">Gender</th>
                                            <th class="border-bottom p-2">Address</th>
                                            <th class="border-bottom p-2">Day</th>
                                            <th class="border-bottom p-2">Start Time</th>
                                            <th class="border-bottom p-2">End Time</th>
                                        ...
                                        <?php if (@$doctor) {
                                            foreach ($doctor as $item) { ?>
                                                <tr>
                                                    ...
                                                    <td class="p-3"><?= $item['stime'] ?></td>
                                                    <td class="p-3"><?= $item['etime'] ?></td>
                                                    <td class="p-3">$<?= $item['fees'] ?></td>
                                                    <td> <a href="<?= base_url('drdelete/' . $item['dr_id']) ?> " onclick="return confirmDelete(event)" ><i style="font-size:20px;color:red;" class="fa fa-trash" aria-hidden="true"></i></a>
                                                        <a href="<?= base_url('dredit/' . $item['dr_id']) ?>" onclick="return confirmUpdate(event)"><i style="font-size:20px;" class="fa fa-pencil-square" aria-hidden="true"></i></a>
                                                    </td>
