...
<!-- Mirrored from shreethemes.in/doctris/layouts/admin/index-rtl.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Nov 2023 11:25:34 GMT -->
<head>
        <meta charset="utf-8" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-lg-6 mt-4">
                                <div class="card chat chat-person border-0 shadow rounded">
                                    ...
                                    <ul class="p-4 list-unstyled mb-0 chat" data-simplebar style="background: url('<?=base_url()?>assets/images/bg/bg-chat.png') center center; max-height: 295px;">
                                        <li>
                                ...
                                <div class="card border-0 shadow rounded">
                                    ...
                                    <ul class="list-unstyled mb-0 p-4" data-simplebar style="height: 355px;">
                                        <li class="d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center">
                                                <img src="<?=base_url()?>assets/images/doctors/01.jpg" class="avatar avatar-small rounded-circle border shadow" alt="">
                                        ...
                                        <li class="d-flex align-items-center justify-content-between mt-4">
                                            <div class="d-flex align-items-center">
                                                <img src="<?=base_url()?>assets/images/doctors/02.jpg" class="avatar avatar-small rounded-circle border shadow" alt="">
                                                <div class="flex-1 ms-3">
                                        ...
                                        <li class="d-flex align-items-center justify-content-between mt-4">
                                            <div class="d-flex align-items-center">
                                                <img src="<?=base_url()?>assets/images/doctors/03.jpg" class="avatar avatar-small rounded-circle border shadow" alt="">
                                                <div class="flex-1 ms-3">
                                        ...
                                        <li class="d-flex align-items-center justify-content-between mt-4">
                                            <div class="d-flex align-items-center">
                                                <img src="<?=base_url()?>assets/images/doctors/04.jpg" class="avatar avatar-small rounded-circle border shadow" alt="">
                                                <div class="flex-1 ms-3">
                                        ...
                                        <li class="d-flex align-items-center justify-content-between mt-4">
                                            <div class="d-flex align-items-center">
                                                <img src="<?=base_url()?>assets/images/doctors/05.jpg" class="avatar avatar-small rounded-circle border shadow" alt="">
                                                <div class="flex-1 ms-3">
...
<!-- Mirrored from shreethemes.in/doctris/layouts/admin/index-rtl.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Nov 2023 11:25:35 GMT -->
</html>