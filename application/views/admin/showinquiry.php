                ...
                <div class="layout-specing">
                    <div class="row">
                        <div class="col-xl-9 col-md-6">
                            <h5 class="mb-0">Inquires List</h5>
                        ...
                        <div class="col-xl-3 col-md-6 mt-4 mt-md-0 text-md-end">
                            <!-- <a href="<?= base_url('pages') ?>" class="btn btn-primary">Add New Page</a> -->
                        </div><!--end col-->
                    </div><!--end row-->
                                ...
                                <table class="table mb-0 table-center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-bottom p-2" style="min-width: 100px;">Subject</th>
                                            <th class="border-bottom p-2" style="min-width: 100px;">Comment</th>
                                    ...
                                    <tbody>
                                        <?php if (@$inquiry) {
                                            foreach ($inquiry as $item) { ?>
                                                <tr>
                                                    <th class="p-3"><?= $item['in_id'] ?></th>
                                                    <td class="p-3"> <?= $item['in_name'] ?></td>
                                                    <td class="p-3"> <?= $item['in_email'] ?></td>
                                                    <td class="p-3"> <?= $item['in_subject'] ?></td>
                                                    <td class="p-3"> <?= $item['in_comments'] ?></td>
                                                    <!-- <td class="p-3"><?= $item['slug'] ?></td> -->
                                                    <!-- <td class="p-3"><?= $item['status'] ?></td> -->
                                                    <td> <a href="<?= base_url('inquirydelete/' . $item['in_id']) ?>"><i style="font-size:20px;color:red;" class="fa fa-trash" aria-hidden="true"></i></a>
                                                        <!-- <a href="<?= base_url('pgedit/' . $item['pg_id']) ?>"><i style="font-size:20px;" class="fa fa-pencil-square" aria-hidden="true"></i></a> -->
                                                    </td>
