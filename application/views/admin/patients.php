...
<!-- Mirrored from shreethemes.in/doctris/layouts/admin/patients.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Nov 2023 11:25:39 GMT -->
<head>
        <meta charset="utf-8" />
                                ...
                                <div class="table-responsive shadow rounded">
                                    <table class="table table-center bg-white mb-0">
                                        ...
                                        <?php if(@$patient)
                                         ...
                                         { ?>
                                            <tr>
                                                <th class="p-3"><?=$item['pt_id']?></th>
                                                <td class="p-3">
                                                    <a href="#" class="text-dark">
                                                        <div class="d-flex align-items-center">
                                                        
                                                            <img src="<?php echo base_url('uploads/') . $item['image']; ?>" class="avatar avatar-md-sm rounded-circle shadow" alt="" ">
                                                            <span class="ms-2"> <?=$item['pt_name']?></span>
                                                        </div>
                                                    </a>
                                                </td>
                                                <!-- <td class="p-3">  <?=$item['pt_name']?></td> -->
                                                <!-- <td class="p-3"> <?=$item['email']?></td> -->
                                                <td class="p-3"><?=$item['pt_age']?></td>
                                                <td class="p-3"><?=$item['pt_gender']?></td>
                                                <td class="p-3"><?=$item['pt_address']?></td>
                                                <td class="p-3"><?=$item['pt_phone']?></td>
                                                <td class="p-3"><?=$item['pt_department']?></td>
                                                <td class="p-3"><?=$item['pt_date']?></td>
                                                <td class="p-3"><?=$item['pt_time']?></td>
                                                ...
                                                <!-- <td class="p-3">
                                                    <a href="#" class="text-dark">
                                                        <div class="d-flex align-items-center">
                                                            <img src="<?=base_url()?>assets/images/doctors/01.jpg" class="avatar avatar-md-sm rounded-circle border shadow" alt=""  style="width:80px;height:80px;">
                                                            <span class="ms-2"> <?=$item['fname']?></span>
                                                        </div>
                                                    </a>
                                                </td> -->
                                                ...
                                                <td> <a href="<?= base_url('ptdelete/'.$item['pt_id'])?>"><i style="font-size:20px;color:red;" class="fa fa-trash" ></i></a>
                                                     <a href="<?= base_url('ptedit/'.$item['pt_id']) ?>"><i style="font-size:20px;" class="fa fa-pencil-square" ></i></a>
                                                </td>
                                            </tr>
                                            <?php } }?>
