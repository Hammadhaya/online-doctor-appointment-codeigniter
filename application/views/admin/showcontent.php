                                ...
                                <table class="table mb-0 table-center">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-bottom p-2" style="min-width: 100px;">Page Name</th>
                                            <!-- <th class="border-bottom p-2" style="min-width: 100px;"></th> -->
                                            <th class="border-bottom p-2">H1</th>
                                            <th class="border-bottom p-2">H2</th>
                                            <th class="border-bottom p-2">Description</th>
                                            <th class="border-bottom p-2">keyword</th>
                                            <th class="border-bottom p-2">title</th>
                                    ...
                                    <tbody>
                                        <?php if (isset(@$content)) {
                                            foreach ($content as $item) { ?>
                                                <tr>
                                                    <th class="p-3"><?= $item['c_id'] ?></th>
                                                    <td class="p-3"> <?= $item['pg_name'] ?></td>
                                                    <td class="p-3"><?= $item['h1'] ?></td>
                                                    <td class="p-3"><?= $item['h2'] ?></td>
                                                    ...
                                                    <td> <a href="<?= base_url('cdelete/' . $item['c_id']) ?>"><i style="font-size:20px;color:red;" class="fa fa-trash" aria-hidden="true"></i></a>
                                                        <a href="<?= base_url('cedit/' . $item['c_id']) ?>"><i style="font-size:20px;" class="fa fa-pencil-square" aria-hidden="true"></i></a>
                                                    </td>
