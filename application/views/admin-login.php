<?php
// if ($this->session->userdata('tempadmin') == true) {
//     echo '
//     <div class="alert alert-danger" role="alert">
//         Invalid email or password. Please try again.
//     </div>';
//     $this->session->unset_userdata('tempadmin');
// }
?>
...
<?php
//    $this->session->unset_userdata($_SESSION['tempadmin']);} ?>
                   ...
                   <?php
                    ...
                    <div class="card login-page shadow mt-4 rounded border-0">
                        <div class="card-body">
                            ...
                            <form id="adminform" action="<?= base_url('admin-identify') ?>" method="post" class="login-form mt-4">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="mb-3">
                                            <label class="form-label">Your Email <span class="text-danger">*</span></label>
                                            <input type="email"  id="error-alert" class="form-control" placeholder="Email" name="email" required="">
                                    ...
                                    <div class="col-lg-12 mb-0">
                                        <div class="d-grid">
                                            <button type="button" onclick=" validateAdmin() " class="btn btn-primary">Login in</button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 text-center">
                                        <p class="mb-0 mt-3"><small class="text-dark me-2">Don't have an account ?</small> <a href="<?= base_url('adminsignup-page') ?>" class="text-dark fw-bold">Sign Up</a></p>
                                    </div>
                                </div>
                            </form>
                        </div>
