...
<!-- Mirrored from shreethemes.in/doctris/layouts/landing/aboutus.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 May 2023 15:25:32 GMT -->
<head>
        <meta charset="utf-8" />
    ...
    <body>
        ...
        <!-- Start Hero -->
        <section class="bg-half-170 d-table w-100" style="background: url('<?=base_url()?>assets/images/bg/about.jpg') center center;">
